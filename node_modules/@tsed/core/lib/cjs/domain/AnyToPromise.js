...
class AnyToPromise {
    constructor({ hasNextFunction = false } = {}) {
        ...
        tslib_1.__classPrivateFieldSet(this, _AnyToPromise_hasNextFunction, hasNextFunction, "f");
        tslib_1.__classPrivateFieldSet(this, _AnyToPromise_promise, new Promise((resolve, reject) => {
            tslib_1.__classPrivateFieldSet(this, _AnyToPromise_resolves, resolve, "f");
            tslib_1.__classPrivateFieldSet(this, _AnyToPromise_rejects, reject, "f");
        }), "f");
    }
    isDone() {
    ...
    get next() {
        tslib_1.__classPrivateFieldSet(this, _AnyToPromise_hasNextFunction, true, "f");
        return (error) => {
            if (this.isDone()) {
                return;
            }
    ...
    async call(cb) {
        ...
        return tslib_1.__classPrivateFieldGet(this, _AnyToPromise_promise, "f");
    }
    reject(er) {
        if (this.isDone()) {
            return;
        ...
        tslib_1.__classPrivateFieldGet(this, _AnyToPromise_rejects, "f").call(this, er);
    }
    resolve(response = {}) {
        if (this.isDone()) {
            return;
        ...
        tslib_1.__classPrivateFieldGet(this, _AnyToPromise_resolves, "f").call(this, { ...response, state: AnyToPromiseStatus.RESOLVED });
    }
    destroy() { }
    cancel() {
        if (this.isDone()) {
        ...
        return tslib_1.__classPrivateFieldGet(this, _AnyToPromise_resolves, "f").call(this, { state: AnyToPromiseStatus.CANCELED });
    }
    done(status) {
        this.destroy();
        this.status = status;
    ...
    handle(process, additionalProps = {}) {
        ...
        if (!tslib_1.__classPrivateFieldGet(this, _AnyToPromise_hasNextFunction, "f")) {
