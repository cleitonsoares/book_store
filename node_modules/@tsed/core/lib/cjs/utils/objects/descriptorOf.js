...
exports.isMethodDescriptor = exports.descriptorOf = void 0;
/**
...
function isMethodDescriptor(target, propertyKey) {
    var _a;
    return (_a = descriptorOf(target, propertyKey)) === null || _a === void 0 ? void 0 : _a.value;
}
exports.isMethodDescriptor = isMethodDescriptor;
//# sourceMappingURL=descriptorOf.js.map