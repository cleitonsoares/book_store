...
class ContextLogger {
    constructor(logger, { id, url = "", dateStart = new Date(), ignoreUrlPatterns = [], minimalRequestPicker, completeRequestPicker, level = "all", maxStackSize = 30, ignoreLog, additionalProps }) {
        ...
        // @ts-ignore
        this.level = (0, logger_1.levels)()[level.toUpperCase()] || (0, logger_1.levels)().ALL;
        this.maxStackSize = maxStackSize;
    }
    info(obj) {
        this.run((0, logger_1.levels)().INFO, obj, (obj) => this.minimalRequestPicker(this.getData(obj)));
        return this;
    }
    debug(obj, withRequest = true) {
        this.run((0, logger_1.levels)().DEBUG, obj, (obj) => {
    ...
    warn(obj) {
        this.run((0, logger_1.levels)().WARN, obj, (obj) => this.completeRequestPicker(this.getData(obj)));
        return this;
    }
    error(obj) {
        this.run((0, logger_1.levels)().ERROR, obj, (obj) => this.completeRequestPicker(this.getData(obj)));
        return this;
    }
    trace(obj) {
        this.run((0, logger_1.levels)().TRACE, obj, (obj) => this.completeRequestPicker(this.getData(obj)));
        return this;
    }
    flush() {
