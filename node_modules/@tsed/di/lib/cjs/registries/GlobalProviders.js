"use strict";
var _GlobalProviderRegistry_settings;
...
class GlobalProviderRegistry extends Map {
    constructor() {
        super(...arguments);
        _GlobalProviderRegistry_settings.set(this, new Map());
    }
    /**
     ...
     */
    get(key) {
        return super.get((0, core_1.getClassOrSymbol)(key));
    }
    /**
     ...
     */
    has(key) {
        return super.has((0, core_1.getClassOrSymbol)(key));
    }
    /**
     ...
     */
    set(key, metadata) {
        super.set((0, core_1.getClassOrSymbol)(key), metadata);
        return this;
    }
    /**
     *
     ...
     */
    delete(key) {
        return super.delete((0, core_1.getClassOrSymbol)(key));
    }
    createRegistry(type, model, options = {}) {
        ...
        tslib_1.__classPrivateFieldGet(this, _GlobalProviderRegistry_settings, "f").set(type, options);
        return this;
    }
    onInvoke(provider, locals, options) {
        const settings = tslib_1.__classPrivateFieldGet(this, _GlobalProviderRegistry_settings, "f").get(provider.type);
        if (settings === null || settings === void 0 ? void 0 : settings.onInvoke) {
    ...
    getRegistrySettings(target) {
        ...
        return (tslib_1.__classPrivateFieldGet(this, _GlobalProviderRegistry_settings, "f").get(type) || {
    ...
    createIfNotExists(key, options) {
        const type = options.type || ProviderType_1.ProviderType.PROVIDER;
        if (!this.has(key)) {
            const { model = Provider_1.Provider } = tslib_1.__classPrivateFieldGet(this, _GlobalProviderRegistry_settings, "f").get(type) || {};
...
_GlobalProviderRegistry_settings = new WeakMap();
/**
 *
