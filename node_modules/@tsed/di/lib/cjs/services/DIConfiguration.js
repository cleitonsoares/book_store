...
class DIConfiguration {
    constructor(initialProps = {}) {
        ...
        return (0, core_1.proxyDelegation)(this, {
            ownKeys(target) {
    ...
    setRaw(propertyKey, value) {
        (0, core_1.setValue)(this.map, propertyKey, value);
        return this;
    }
    /**
     *
    ...
    getRaw(propertyKey, defaultValue) {
        const value = (0, core_1.getValue)(this.map, propertyKey);
        if (value !== undefined) {
            return value;
        }
        return (0, core_1.getValue)(this.default, propertyKey, defaultValue);
    }
    merge(obj) {
        Object.entries(obj).forEach(([key, value]) => {
            const descriptor = Object.getOwnPropertyDescriptor(DIConfiguration.prototype, key);
            const originalValue = this.get(key);
            value = (0, core_1.deepMerge)(value, originalValue);
    ...
    resolve(value) {
        if (typeof value === "object" && value !== null) {
            if (![Array, Object].includes((0, core_1.classOf)(value))) {
                return value;
            }
        ...
        if (typeof value === "string") {
            const replacer = (match, key) => (0, core_1.getValue)(this.map, key);
            return value
    ...
    build() {
        ...
        this.get = this.getRaw = (propertyKey, defaultValue) => (0, core_1.getValue)(this.map, propertyKey, defaultValue);
    }
}
