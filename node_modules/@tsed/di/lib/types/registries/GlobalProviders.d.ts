...
export declare class GlobalProviderRegistry extends Map<TokenProvider, Provider> {
    ...
    onInvoke(provider: Provider, locals: Map<TokenProvider, any>, options: ResolvedInvokeOptions & {
        injector: InjectorService;
    }): void;
    getRegistrySettings(target: string | TokenProvider): RegistrySettings;
    createRegisterFn(type: string): (provider: any | ProviderOpts, instance?: any) => void;
    /**
     *
     * @param key
     * @param options
