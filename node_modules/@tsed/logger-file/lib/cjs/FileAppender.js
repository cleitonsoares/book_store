...
// @ts-ignore
const streams = tslib_1.__importStar(require("streamroller"));
const eol = Os.EOL || "\n";
/**
 * ## File Appender
 *
 ...
 *
 */
let FileAppender = class FileAppender extends logger_1.BaseAppender {
    /**
     *
     */
    reopen() {
...
FileAppender = tslib_1.__decorate([
    (0, logger_1.Appender)({ name: "file", defaultLayout: "basic" })
], FileAppender);
