...
import { DIContext, Inject, Interceptor } from "@tsed/di";
...
__decorate([
    Inject(),
    __metadata("design:type", PlatformCache)
...
PlatformCacheInterceptor = __decorate([
    Interceptor()
], PlatformCacheInterceptor);
export { PlatformCacheInterceptor };
