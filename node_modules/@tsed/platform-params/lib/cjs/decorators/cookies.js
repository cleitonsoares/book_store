...
exports.Cookies = exports.CookiesParams = void 0;
...
function CookiesParams(...args) {
    const { expression, useType, useConverter = false, useValidation = false } = (0, mapParamsOptions_1.mapParamsOptions)(args);
    return (0, useParam_1.UseParam)({
        paramType: ParamTypes_1.ParamTypes.COOKIES,
        expression,
        useType,
        useConverter,
        useValidation
