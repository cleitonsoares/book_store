 ...
 * @pipe
 */
export declare function UseParam(options: Partial<ParamOptions>): ParameterDecorator;
/**
 * @deprecated Since v6
 */
export declare function UseParam(paramType: string, options?: Partial<ParamOptions>): ParameterDecorator;
