...
let JsonMethodStore = class JsonMethodStore extends JsonEntityStore_1.JsonEntityStore {
    constructor(options) {
        ...
        this.parent = JsonEntityStore_1.JsonEntityStore.from(this.target);
        this.middlewares = [];
         ...
         */
        this.operation = new JsonOperation_1.JsonOperation();
        /**
    ...
    getResponseOptions(status, contentType = "application/json") {
