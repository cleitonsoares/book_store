...
class JsonSchema extends Map {
    ...
    get alias() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f");
    }
    get nestedGenerics() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_nestedGenerics, "f");
    }
    set nestedGenerics(value) {
        tslib_1.__classPrivateFieldSet(this, _JsonSchema_nestedGenerics, value, "f");
    }
    get genericLabels() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_genericLabels, "f");
    }
    set genericLabels(value) {
        tslib_1.__classPrivateFieldSet(this, _JsonSchema_genericLabels, value, "f");
    }
    get isClass() {
        return (0, core_1.isClass)(this.class) && ![Map, Array, Set, Object, Date, Boolean, Number, String].includes(tslib_1.__classPrivateFieldGet(this, _JsonSchema_target, "f"));
    }
    /**
     * Current schema is a collection
     */
    get isCollection() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_isCollection, "f");
    }
    /**
     * Current schema is a generic
     */
    get isGeneric() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_isGeneric, "f");
    }
    /**
    ...
    get canRef() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_ref, "f");
    }
    get isNullable() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_nullable, "f") || this.$allow.includes(null);
    }
    get isReadOnly() {
    ...
    nullable(value) {
        tslib_1.__classPrivateFieldSet(this, _JsonSchema_nullable, value, "f");
    }
    itemSchema(obj = {}) {
        tslib_1.__classPrivateFieldSet(this, _JsonSchema_itemSchema, tslib_1.__classPrivateFieldGet(this, _JsonSchema_itemSchema, "f") || mapToJsonSchema(obj), "f");
        tslib_1.__classPrivateFieldGet(this, _JsonSchema_itemSchema, "f").assign(obj);
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_itemSchema, "f");
    }
    getAliasOf(property) {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").get(property);
    }
    addAlias(property, alias) {
        tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").set(property, alias);
        tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").set(alias, property);
        return this;
    }
    removeAlias(property) {
        const alias = tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").get(property);
        alias && tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").delete(alias);
        tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").delete(property);
        return this;
    }
    $id($id) {
        super.set("$id", $id);
     ...
     */
    label(name) {
        tslib_1.__classPrivateFieldSet(this, _JsonSchema_ref, true, "f");
        super.set("name", name);
        return this;
    }
    name(name) {
     ...
     */
    items(items) {
        super.set("items", (tslib_1.__classPrivateFieldSet(this, _JsonSchema_itemSchema, mapToJsonSchema(items), "f")));
        return this;
    }
    /**
    ...
    type(type) {
        switch (type) {
            case Map:
                ...
                tslib_1.__classPrivateFieldSet(this, _JsonSchema_target, type, "f");
                tslib_1.__classPrivateFieldSet(this, _JsonSchema_isCollection, true, "f");
            ...
            default:
                if ((0, core_1.isClass)(type) || (0, core_1.isFunction)(type)) {
                    ...
                    if (jsonType === "generic") {
                        tslib_1.__classPrivateFieldSet(this, _JsonSchema_isGeneric, true, "f");
                        super.set("$ref", type);
                    }
                    else {
    ...
    assign(obj = {}) {
        ...
        if (obj instanceof JsonSchema) {
            ...
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_ref, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_ref, "f"), "f");
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_alias, new Map(tslib_1.__classPrivateFieldGet(this, _JsonSchema_alias, "f").entries()), "f");
            tslib_1.__classPrivateFieldGet(obj, _JsonSchema_genericLabels, "f") && (tslib_1.__classPrivateFieldSet(this, _JsonSchema_genericLabels, [...tslib_1.__classPrivateFieldGet(obj, _JsonSchema_genericLabels, "f")], "f"));
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_nestedGenerics, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_nestedGenerics, "f").map((item) => [...item]), "f");
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_target, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_target, "f"), "f");
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_isGeneric, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_isGeneric, "f"), "f");
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_isCollection, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_isCollection, "f"), "f");
            tslib_1.__classPrivateFieldSet(this, _JsonSchema_ref, tslib_1.__classPrivateFieldGet(obj, _JsonSchema_ref, "f"), "f");
     ...
     */
    getComputedType() {
        return (0, getComputedType_1.getComputedType)(tslib_1.__classPrivateFieldGet(this, _JsonSchema_target, "f"));
    }
    getComputedItemType() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_itemSchema, "f") ? tslib_1.__classPrivateFieldGet(this, _JsonSchema_itemSchema, "f").getComputedType() : this.getComputedType();
    }
    /**
    ...
    getTarget() {
        return tslib_1.__classPrivateFieldGet(this, _JsonSchema_target, "f");
    }
    /**
     * Get the symbolic name of the entity
     */
    getName() {
        return this.get("name") || (tslib_1.__classPrivateFieldGet(this, _JsonSchema_target, "f") ? (0, core_1.nameOf)((0, core_1.classOf)(this.getComputedType())) : "");
    }
    clone() {
