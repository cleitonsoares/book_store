...
function extractRequiredProps(obj, schema, options) {
    ...
    return (0, alterRequiredGroups_1.alterRequiredGroups)((0, core_1.uniq)(required), schema, options);
}
/**
 * @ignore
 */
function getRequiredProperties(obj, schema, options) {
    ...
    required = (0, core_1.uniq)(required).reduce(mapRequiredProps(obj, schema, options), []);
    if (required.length) {
        return {
            ...obj,
            required
