...
exports.transformToOS2 = exports.Converter = exports.transformInformation = exports.transformSecurity = void 0;
...
function transformSecurity(securitySchemes) {
...
function transformInformation(server) {
...
exports.transformInformation = transformInformation;
class Converter {
    constructor(spec) {
                    ...
                    if (param.schema.type === "object" && param.schema.properties) {
                        ...
                        Object.keys(param.schema.properties).forEach((name) => {
                            ...
                            if (!schema.readOnly) {
                                ...
                                (_a = operation.parameters) === null || _a === void 0 ? void 0 : _a.push(formDataParam);
                            }
                        });
                    }
                    else {
...
function transformToOS2(spec) {
    return new Converter(spec).convert();
}
exports.transformToOS2 = transformToOS2;
//# sourceMappingURL=transformToOS2.js.map